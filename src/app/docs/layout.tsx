...
export const metadata: Metadata = {
  ...
  description:
    'SiroPHP documentation hub: quick start, install, CLI reference (80+ commands), and production debugging workflow. Build APIs fast, debug faster.',
  ...
  openGraph: {
    ...
    description:
      'SiroPHP documentation hub: quick start, install, CLI reference (80+ commands), and production debugging workflow.',
