...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. 1,294 tests with 100% pass rate (868 core + 426 app), security audited (37 attack vectors, 0 vulnerabilities), and features like JWT auth, rate limiting, CSRF protection, and log sanitization.',
  },
  {
