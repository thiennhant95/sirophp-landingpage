...
export const doc: Doc = {
  meta: {
    ...
    description: "Siro ships with **95 CLI commands**. Every task — from project creation to production debugging — is done from the terminal. No GUI tools needed.",
    category: "api",
    order: 0,
    icon: "⚙️",
  },
  ...
  {
    "type": "p",
    "text": "Siro ships with **95 CLI commands**. Every task — from project creation to production debugging — is done from the terminal. No GUI tools needed."
  },
  {
    "type": "code",
    "lang": "bash",
